                    ...
                    <div class="owl-carousel owl-theme wow fadeInUp">
                        <div class="item">
                            <div class="list-testimonials">
                                <div class="box-item">
                                    ...
                                    <div class="staff-img">
                                        <img src="{{ asset('images/team/staff-box1.jpg')}}" alt="images">
                                    </div>
                        ...
                        <div class="list-testimonials">
                            <div class="box-item">
                                ...
                                <div class="staff-img">
                                    <img src="{{ asset('images/team/staff-box2.jpg')}}" alt="images">
                                </div>
                        ...
                        <div class="list-testimonials">
                            <div class="box-item">
                                <div class="box-item-overlay"></div>
                                <div class="staff-img">
                                    <img src="{{ asset('images/team/staff-box3.jpg')}}" alt="images">
                                </div>
                                <p class="section-desc mg-bottom-15"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
                                    at est id leo luctus gravida a in ipsum. </p>
