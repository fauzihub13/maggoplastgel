                        ...
                        <div class="top-footer wow fadeInDown">
                            <div class="top-footer-left">
                                <div class="logo-footer">
                                    <a href="#"><img src="{{ asset('assets/icon/logo-light.png') }}" alt="images"></a>
                                </div>
                            </div>
                            ...
                            <div class="footer-item">
                                <div class="widgets-menu-1 padding-top-listfooter">
                                    ...
                                    <ul class="list-menu-1 text-decs link-style4">
                                        <li><a href="#">Brangding Design</a> </li>
                                        <li><a href="#">Ui/ux Designing</a> </li>
                                        <li><a href="#">Maek Elements</a> </li>
                            ...
                            <div class="footer-item padding-top-listfooter">
                                <div class="widgets-menu-2">
                                    ...
                                    <ul class="list-menu-2 text-decs link-style4">
                                        <li>
                                            <h3 class="heading-menu2"><a href="#">Bigg Ideas Of Business branding Info.</a></h3>
                                            <span class="post-date"><span class="entry-date">December 7, 2021</span></span>
                                        </li>
                                        <li>
                                            <h3 class="heading-menu2"><a href="#">Bigg Ideas Business branding Info.</a></h3>
                                            <span class="post-date"><span class="entry-date">December 7, 2021</span></span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="widgets-subcribes">
                                    ...
                                    <div class="widgets-input-subcribes">
                                        <form method="post" class="form-subcribe">
                                            <input id="email" type="email" name="email" class="widgets-text-input" placeholder="Email Address" required>
